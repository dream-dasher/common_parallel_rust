...
impl TypesManual {
        ...
        pub fn get_details_as_strings(&self) -> TypeDetails<String> {
                match self {
                        ...
                        TypesManual::NonZeroU128 =>
                                get_type_details::<NonZero<u128>>().as_strings(),
                        TypesManual::NonZeroUsize =>
                                get_type_details::<NonZero<usize>>().as_strings(),
                        ...
                        TypesManual::NonZeroI128 =>
                                get_type_details::<NonZero<i128>>().as_strings(),
                        TypesManual::NonZeroIsize =>
                                get_type_details::<NonZero<isize>>().as_strings(),
                }
        }
}
...
where T: TypeInfo + std::fmt::Display {
        TypeDetails {
                name: T::type_name(),
                min:  T::min_value(),
                max:  T::max_value(),

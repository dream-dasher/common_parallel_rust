...
fn main() {
       ...
       eframe::run_native("CodeEditor", native_options, Box::new(|_cc| Ok(Box::new(CodeVarsExample::default())))).unwrap();
}
// ///////////////////////////////// [ App Memory ] ///////////////////////////////// //
//                                     and init
#[derive(Debug)]
...
impl Default for CodeVarsExample {
       fn default() -> Self { Self { name: "Arthur".to_owned(), age: 42, l_val: 40.0, r_val: 20.0, _show_bar: true } }
}
...
impl eframe::App for CodeVarsExample {
       fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
              egui::SidePanel::right("my_panel").show(ctx, |ui| {
                     ...
                     ui.add_sized([self.l_val, self.r_val], egui::DragValue::new(&mut self.l_val).range(5.0..=f32::MAX).prefix("x"));
                     ui.add_sized([self.l_val, self.r_val], egui::DragValue::new(&mut self.r_val).range(5.0..=f32::MAX).prefix("y"));

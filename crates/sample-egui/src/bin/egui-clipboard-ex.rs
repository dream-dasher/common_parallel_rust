...
fn main() {
    ...
    eframe::run_native("Clipboard Test",
                       native_options,
                       Box::new(|cc| Ok(Box::new(ClipboardTest::new(cc))))).unwrap();
}
...
impl ClipboardTest {
    ...
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        if !cfg!(target_arch = "wasm32") {
            ...
            ui.horizontal(|ui| {
                  for (name, cmd) in [("Copy", egui::ViewportCommand::RequestCopy),

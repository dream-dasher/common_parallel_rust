...
use eframe::egui;
use reqwest::{
        self, Client as ReqClient, Method, StatusCode, Url,
...
impl FuturesApp {
        ...
        fn metered_queue_request(&mut self, ctx: egui::Context) {
                ...
                let atomic_counter = self
                        .request_tasks_to_create
                        .clone();
        ...
        fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
               ...
               if ui.button("Drop Request Generator(s)").clicked() {
                ...
                egui::CentralPanel::default().show(ctx, |ui| {
                        ...
                        ui.label(format!(
                                "Request-Task Generators active: {}",
                        ...
                        ui.add(egui::Slider::new(&mut self.delay_sec, 0..=10)
                                .text("Server Response Delay (sec)"));
                        ui.add(egui::Slider::new(
                                &mut self.requests_to_queue,
                                NON_ZERO_MIN..=NON_ZERO_MAX,
                        )
                        .logarithmic(true)

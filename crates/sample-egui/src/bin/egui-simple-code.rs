...
fn main() {
    ...
    eframe::run_native("CodeEditor",
                       native_options,
                       Box::new(|_cc| Ok(Box::new(CodeEditorExample::default())))).unwrap();
}
// ///////////////////////////////// [ App Memory ] ///////////////////////////////// //
//                                     and init
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.collapsing("Theme", |ui| {
                  ui.group(|ui| {
                        code_theme.ui(ui);
                        code_theme.clone()
                                  .store_in_memory(ui.ctx());
                    });
              });

            let mut layouter = |ui: &egui::Ui, string: &dyn egui::TextBuffer, wrap_width: f32| {
                let mut layout_job = egui_extras::syntax_highlighting::highlight(ui.ctx(),
                                                                                 ui.style(),
                                                                                 &code_theme,
                                                                                 string.as_str(),
                                                                                 language);

...
fn main() {
       ...
       eframe::run_native("CodeEditor", native_options, Box::new(|_cc| Ok(Box::new(CodeEditorExample::default())))).unwrap();
}
// ///////////////////////////////// [ App Memory ] ///////////////////////////////// //
//                                     and init
...
impl Default for CodeEditorExample {
       ...
       fn default() -> Self { Self { language: "rs".into(), code: CODE_SAMPLE.into() } }
}
...
impl eframe::App for CodeEditorExample {
       fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
              egui::CentralPanel::default().show(ctx, |ui| {
                     ...
                     let mut code_theme = egui_extras::syntax_highlighting::CodeTheme::from_memory(ui.ctx(), ui.style());

    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
                                         ...
                                         ui.horizontal(|ui| {
                                               ...
                                               ui.add(egui::Slider::new(&mut temp_grid_size,
                                                                        5..=30).text("Grid Size"));
                                               if ui.button("Apply Size")
                                                    .clicked()
                                               {
                                         ...
                                         for i in 0..=self.grid_size {
                                             ...
                                             // Horizontal line
                                             ui.painter()
                                               .line_segment([egui::Pos2::new(grid_rect.min.x, y),
                                                              egui::Pos2::new(grid_rect.max.x, y)],
                                                             Stroke::new(1.0, Color32::GRAY));

                                             // Vertical line
                                             ui.painter()
                                               .line_segment([egui::Pos2::new(x, grid_rect.min.y),
                                         ...
                                         for row in 0..self.grid.len() {
                                             for col in 0..self.grid[row].len() {
                                                 let cell_min_x =
                                                     grid_rect.min.x + (col as f32 * cell_size);
                                                 let cell_min_y =
                                                     grid_rect.min.y + (row as f32 * cell_size);
